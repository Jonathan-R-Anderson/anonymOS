...
Currently available applets include:
	...
	ash, awk, basename, bash, bunzip2, bzcat, bzip2, cat, comm, cp, cut,
	date, dd, df, diff, dirname, dmesg, du, echo, egrep, env, expr,
	false, fgrep, find, grep, groups, gunzip, gzip, head, hostname, id,
	ifconfig, kill, killall, less, ln, ls, mkdir, mktemp, mv, paste,
	patch, ping, printenv, printf, ps, readlink, realpath, rm, rmdir,
	sed, seq, sh, sleep, sort, stat, sync, sysctl, tail, tar, tee, test,
	touch, tr, true, uname, uniq, unxz, vi, wc, wget, whoami, xargs, xz,
	yes, zcat
...
tar x|t [-zJjavokO] [-f TARFILE] [-C DIR] [FILE]...
...
wget [-cqS] [-O FILE] [-o LOGFILE] [-Y on/off] [-P DIR] [-U AGENT] URL...
