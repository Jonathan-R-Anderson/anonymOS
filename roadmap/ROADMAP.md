...
| 3.1 | ◑ **Damage-tracked KMS blit + fast copy** — damage tracking DONE 2026-09-05: **8% of scanlines written** (was 100%), rendering pixel-identical, `boot-test: PASS`. Remaining: non-temporal stores for the rows that are still copied | The roadmap's own "cheap present wins". Biggest felt improvement per hour | DESKTOP_RESP R5 | S |
