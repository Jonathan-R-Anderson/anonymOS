module anonymos.display.server;
...
import anonymos.display.x11_stack;
import anonymos.display.canvas : Canvas, createFramebufferCanvas;
import anonymos.syscalls.posix : spawnRegisteredProcess, pid_t;
...
void attachInputPipeline(ref DisplayServerState state) @nogc nothrow
{
    ...
    {
        import anonymos.drivers.usb_hid : initializeUSBHID, usbHIDAvailable,
