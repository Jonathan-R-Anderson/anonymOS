module anonymos.fallback_shell;

import anonymos.console : print, printLine, printUnsigned;
import anonymos.serial : serialConsoleReady, serialReadByteBlocking, serialWriteByte;
...
@nogc nothrow public void runFallbackShell()
{
    ...
    for (;;)
    {
        ...
        if (command == "tree")
        {
            import anonymos.objects : getRootObject, getObject, ObjectType, ObjectID;
