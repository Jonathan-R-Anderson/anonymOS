module anonymos.kernel.posixutils.context;
...
version (X86_64)
{
    ...
    // `import anonymos.kernel.posixutils.context : jmp_buf;` to fail.  Marking it as
    // `public` ensures the scheduler structures in `anonymos.posix` can use
