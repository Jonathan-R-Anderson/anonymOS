module anonymos.userland;

import anonymos.console : print, printLine, printStageHeader, printStatusValue,
    printUnsigned, putChar, clearScreen;
import anonymos.display.server : DisplayProtocol, DisplayServerConfig,
    DisplayServerState, attachFontStack, attachInputPipeline,
    bootstrapDisplayServer, displayServerReady;
import anonymos.display.x11_stack : DisplayManagerKind, X11StackConfig;

nothrow:
@nogc:

private enum size_t MAX_USER_SERVICES = 13;
