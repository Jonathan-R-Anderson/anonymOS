...
{
    void aes_encrypt(ubyte* buffer, ubyte* key);
    void aes_decrypt(ubyte* buffer, ubyte* key);
    void twofish_encrypt(ubyte* buffer, ubyte* key);
    void twofish_decrypt(ubyte* buffer, ubyte* key);
    void serpent_encrypt(ubyte* buffer, ubyte* key);
    void serpent_decrypt(ubyte* buffer, ubyte* key);
}
