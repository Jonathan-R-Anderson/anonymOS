...
#define HOS_CURRENT_ADDRESS_SPACE 0x00a
...
/* Section 2 - Object capability namespace */
#define HOS_OBJECT_ROOT 0x200
#define HOS_OBJECT_LOOKUP 0x201
#define HOS_OBJECT_TYPE 0x202
#define HOS_OBJECT_CHILD_COUNT 0x203
#define HOS_OBJECT_CHILD_AT 0x204
#define HOS_OBJECT_NAME 0x205
#define HOS_OBJECT_INVOKE 0x206
...
#define HOS_ERR_NO_SUCH_OBJECT (HOS_ERROR - 6)
#define HOS_ERR_NOT_OBJECT_DIRECTORY (HOS_ERROR - 7)
#define HOS_ERR_OBJECT_PERMISSION_DENIED (HOS_ERROR - 8)
#define HOS_ERR_UNSUPPORTED_OBJECT_METHOD (HOS_ERROR - 9)
...
typedef struct mem_mapping_t {
  ...
  #define MAP_ALLOCATE_IMMEDIATELY_ALIGNED 3
  #define MAP_FROM_PHYSICAL 4
